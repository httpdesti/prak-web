...
<body>
    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<a href='crud/crud.php?id=" . $row["id"] . " ' name='hapus'>Delete</a>"; // Tautan hapus dengan aksi di admin_crud.php
                echo "</td>";
                echo "</tr>";
            }
        }
    ...
    <div id="formTambahData" style="display: none;">
        <h2>Tambah Data</h2>
        <form method="post" action="crud/crud.php" enctype="multipart/form-data">
